    ...
    private void refreshSigns() {
        ...
        for (Sign sign : signsCounter) {
            ...
            if (sign.isSelected() || sign.isChosen()) {
                Colors.setBackgroundColor(signImage, Colors.COLOR_GREY_REACTION);
            } else {
                Colors.setBackgroundColor(signImage, Colors.COLOR_WHITE);
            }

            signsGrid.getChildren().add(signImage);
        }
    }
